...
export default function Footer(){
    return(
        <footer class="bg-white dark:bg-black ">
            <div class="mx-auto max-w-[90%] px-4 pb-6 sm:px-6 lg:px-8">
                <div class="lg:flex lg:items-center lg:justify-between">
                    <div          
                        class="mt-3 flex justify-center text-teal-600 dark:text-teal-300 sm:justify-start"
                    >
                    <img
                    className="h-20 w-27"
                    src={String (logo)}
                    ...
                    <p
                        class="max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-200 sm:text-right lg:mt-0"
                    >
                        Proud to be Totally Organic since opening in 1985! <br></br>We are dedicated to furthering global sustainability through organic, non-GMO agriculture.
                    </p>
                    
                </div>

                <div
        class="mt-3 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 dark:border-gray-800 md:grid-cols-4 lg:grid-cols-6"
      >
        ...
        <div class="text-center sm:text-left md:col-span-4 lg:col-span-2">
          ...
          <div class="mx-auto mt-8 max-w-md sm:ms-0">
            <p
              class="text-center leading-relaxed text-gray-500 dark:text-gray-400 ltr:sm:text-left rtl:sm:text-right"
            >
            ...
            <form class="mt-4">
              ...
              >
                ...
                <input
                  class="w-full rounded-full border-gray-200 bg-white px-6 py-3 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                  type="email"
      ...
      <div
        class="mt-16 border-t border-gray-100 pt-6 dark:border-gray-800 sm:flex sm:items-center sm:justify-between"
      >
        <p
